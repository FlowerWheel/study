...
map ,tg :!ctags -R --c++-kinds=+p --fields=+iaS --extra=+q --language-force=C++
nnoremap ,' '
...
set tabstop=4
set tags=./tags,./TAGS,tags,TAGS,/usr/share/vim/vim73/doc/tags,$VIMFILES/doc/tags,~/.vim/tags/systags,~/.vim/tags/cpptags,../include/tags,../lib/tags
